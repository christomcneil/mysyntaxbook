...
\end{minipage} & 25 distinct values & \includegraphics{/tmp/ds0078.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 7 (21.9\%)\\
8 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0079.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 27 distinct values & \includegraphics{/tmp/ds0080.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0081.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0082.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 1 (0.3)\strut
\end{minipage} & 29 distinct values & \includegraphics{/tmp/ds0083.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 2 (0.1)\strut
\end{minipage} & 30 distinct values & \includegraphics{/tmp/ds0084.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 18 (56.2\%)\\
1 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0085.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 19 (59.4\%)\\
1 : 13 (40.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0086.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
4 : 12 (37.5\%)\\
5 : 5 (15.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0087.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 1 ( 3.1\%)\\
8 : 1 ( 3.1\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0088.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
\end{longtable}
...
\caption{\label{fig:unnamed-chunk-61}Correlation Plot}
\end{figure}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-79-2.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-83-1.pdf}
