...
## $ date     <date> 2001-05-24, 2001-05-24, 2001-05-24, 2001-05-24, 2001-05-24, 2~
## $ carnames <chr> "Mazda RX4", "Mazda RX4 Wag", "Datsun 710", "Hornet 4 Drive",~
## $ valves   <dbl> 24, 24, 16, 24, 32, 24
\end{verbatim}
...
\begin{table}
\centering
\begin{tabular}{r|l|l|r|r|l|l|r}
\hline
carb & hp\_cat & loghp & sum & loghp1 & date & carnames & valves\\
\hline
4 & high hp & 2.04139268515822 & 273.90 & 2.041393 & 2001-05-24 & Mazda RX4 & 24\\
\hline
4 & high hp & 2.04139268515822 & 273.90 & 2.041393 & 2001-05-24 & Mazda RX4 Wag & 24\\
\hline
1 & low hp & missing & 204.85 & 0.000000 & 2001-05-24 & Datsun 710 & 16\\
\hline
1 & high hp & 2.04139268515822 & 371.08 & 2.041393 & 2001-05-24 & Hornet 4 Drive & 24\\
\hline
2 & high hp & 2.24303804868629 & 538.15 & 2.243038 & 2001-05-24 & Hornet Sportabout & 32\\
\hline
1 & high hp & 2.02118929906994 & 332.76 & 2.021189 & 2001-05-24 & Valiant & 24\\
\hline
\end{tabular}
\end{table}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-33-1.pdf}
...
\hypertarget{extracting-1st-component}{%
\subsubsection{Extracting 1st component}\label{extracting-1st-component}}
...
\midrule
\endhead
1 & \vtop{\hbox{\strut mpg}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 20.1 (6)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 10.4 \textless{} 19.2 \textless{} 33.9}\hbox{\strut IQR (CV) : 7.4 (0.3)}} & 25 distinct values & \includegraphics{/tmp/ds1120.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
2 & \vtop{\hbox{\strut cyl}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 6.2 (1.8)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 4 \textless{} 6 \textless{} 8}\hbox{\strut IQR (CV) : 4 (0.3)}} & \vtop{\hbox{\strut 4 : 11 (34.4\%)}\hbox{\strut 6 : 7 (21.9\%)}\hbox{\strut 8 : 14 (43.8\%)}} & \includegraphics{/tmp/ds1121.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
3 & \vtop{\hbox{\strut disp}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 230.7 (123.9)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 71.1 \textless{} 196.3 \textless{} 472}\hbox{\strut IQR (CV) : 205.2 (0.5)}} & 27 distinct values & \includegraphics{/tmp/ds1122.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
4 & \vtop{\hbox{\strut hp}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 146.7 (68.6)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 52 \textless{} 123 \textless{} 335}\hbox{\strut IQR (CV) : 83.5 (0.5)}} & 22 distinct values & \includegraphics{/tmp/ds1123.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
5 & \vtop{\hbox{\strut drat}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 3.6 (0.5)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 2.8 \textless{} 3.7 \textless{} 4.9}\hbox{\strut IQR (CV) : 0.8 (0.1)}} & 22 distinct values & \includegraphics{/tmp/ds1124.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
6 & \vtop{\hbox{\strut wt}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 3.2 (1)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 1.5 \textless{} 3.3 \textless{} 5.4}\hbox{\strut IQR (CV) : 1 (0.3)}} & 29 distinct values & \includegraphics{/tmp/ds1125.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
7 & \vtop{\hbox{\strut qsec}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 17.8 (1.8)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 14.5 \textless{} 17.7 \textless{} 22.9}\hbox{\strut IQR (CV) : 2 (0.1)}} & 30 distinct values & \includegraphics{/tmp/ds1126.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
8 & \vtop{\hbox{\strut vs}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Min : 0}\hbox{\strut Mean : 0.4}\hbox{\strut Max : 1}} & \vtop{\hbox{\strut 0 : 18 (56.2\%)}\hbox{\strut 1 : 14 (43.8\%)}} & \includegraphics{/tmp/ds1127.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
9 & \vtop{\hbox{\strut am}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Min : 0}\hbox{\strut Mean : 0.4}\hbox{\strut Max : 1}} & \vtop{\hbox{\strut 0 : 19 (59.4\%)}\hbox{\strut 1 : 13 (40.6\%)}} & \includegraphics{/tmp/ds1128.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
10 & \vtop{\hbox{\strut gear}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 3.7 (0.7)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 3 \textless{} 4 \textless{} 5}\hbox{\strut IQR (CV) : 1 (0.2)}} & \vtop{\hbox{\strut 3 : 15 (46.9\%)}\hbox{\strut 4 : 12 (37.5\%)}\hbox{\strut 5 : 5 (15.6\%)}} & \includegraphics{/tmp/ds1129.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
11 & \vtop{\hbox{\strut carb}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 2.8 (1.6)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 1 \textless{} 2 \textless{} 8}\hbox{\strut IQR (CV) : 2 (0.6)}} & \vtop{\hbox{\strut 1 : 7 (21.9\%)}\hbox{\strut 2 : 10 (31.2\%)}\hbox{\strut 3 : 3 ( 9.4\%)}\hbox{\strut 4 : 10 (31.2\%)}\hbox{\strut 6 : 1 ( 3.1\%)}\hbox{\strut 8 : 1 ( 3.1\%)}} & \includegraphics{/tmp/ds1130.png} & \vtop{\hbox{\strut 0}\hbox{\strut (0.0\%)}} \\
\bottomrule
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-45-1.pdf}
\caption{\label{fig:unnamed-chunk-45}Correlation Plot}
\end{figure}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\caption{\label{fig:unnamed-chunk-57}Raincoud plot of means}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-59}Scatterplots}
\end{figure}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-60-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-61-1.pdf}
\caption{\label{fig:unnamed-chunk-61}linear Trendline}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-62-1.pdf}
\caption{\label{fig:unnamed-chunk-62}Polynomial trendline}
\end{figure}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-63-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-63-2.pdf}
...
\caption{\label{fig:unnamed-chunk-65}Deviation from predection}
\end{figure}
...
\hypertarget{bbc-style}{%
\section{BBC style}\label{bbc-style}}
...
\begin{verbatim}
## Warning: package 'ggalt' was built under R version 4.0.5
\end{verbatim}
...
\NormalTok{dumbbell\_df }\OtherTok{\textless{}{-}}\NormalTok{ gapminder }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(year }\SpecialCharTok{==} \DecValTok{1967} \SpecialCharTok{|}\NormalTok{ year }\SpecialCharTok{==} \DecValTok{2007}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(country, year, lifeExp) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{spread}\NormalTok{(year, lifeExp) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{gap =} \StringTok{\textasciigrave{}}\AttributeTok{2007}\StringTok{\textasciigrave{}} \SpecialCharTok{{-}} \StringTok{\textasciigrave{}}\AttributeTok{1967}\StringTok{\textasciigrave{}}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(gap)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{head}\NormalTok{(}\DecValTok{10}\NormalTok{)}

\CommentTok{\#Make plot}
\FunctionTok{ggplot}\NormalTok{(dumbbell\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \StringTok{\textasciigrave{}}\AttributeTok{1967}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{xend =} \StringTok{\textasciigrave{}}\AttributeTok{2007}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{y =} \FunctionTok{reorder}\NormalTok{(country, gap), }\AttributeTok{group =}\NormalTok{ country)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_dumbbell}\NormalTok{(}\AttributeTok{colour =} \StringTok{"\#dddddd"}\NormalTok{,}
                \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
                \AttributeTok{colour\_x =} \StringTok{"\#FAAB18"}\NormalTok{,}
                \AttributeTok{colour\_xend =} \StringTok{"\#1380A1"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{bbc\_style}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"We\textquotesingle{}re living longer"}\NormalTok{,}
       \AttributeTok{subtitle=}\StringTok{"Biggest life expectancy rise, 1967{-}2007"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
