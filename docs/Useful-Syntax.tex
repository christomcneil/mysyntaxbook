...
\hypertarget{add-prefix-to-defined-column-names}{%
\subsection{add prefix to defined column names}\label{add-prefix-to-defined-column-names}}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-52-1.pdf}
...
\hypertarget{load-example-data}{%
\paragraph{Load example data}\label{load-example-data}}
...
\hypertarget{creating-random-test-and-train-subsets}{%
\paragraph{Creating random test and train subsets}\label{creating-random-test-and-train-subsets}}
...
\NormalTok{iris}\SpecialCharTok{$}\NormalTok{id }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(iris)}

\CommentTok{\#use 70\% of dataset as training set and 30\% as test set }
\NormalTok{train\_iris }\OtherTok{\textless{}{-}}\NormalTok{ iris }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{sample\_frac}\NormalTok{(}\FloatTok{0.70}\NormalTok{)}
\NormalTok{test\_iris  }\OtherTok{\textless{}{-}}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{anti\_join}\NormalTok{(iris, train\_iris, }\AttributeTok{by =} \StringTok{\textquotesingle{}id\textquotesingle{}}\NormalTok{)}


\NormalTok{train\_iris }\OtherTok{\textless{}{-}}\NormalTok{ train\_iris }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(species, sepal\_length}\SpecialCharTok{:}\NormalTok{petal\_width)}
\NormalTok{test\_iris }\OtherTok{\textless{}{-}}\NormalTok{ test\_iris }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(species, sepal\_length}\SpecialCharTok{:}\NormalTok{petal\_width)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confusionMatrix}\NormalTok{(test\_iris}\SpecialCharTok{$}\NormalTok{pred, test\_iris}\SpecialCharTok{$}\NormalTok{species)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{train\_index\_iris }\OtherTok{\textless{}{-}} \FunctionTok{createDataPartition}\NormalTok{(iris}\SpecialCharTok{$}\NormalTok{species, }\AttributeTok{p =} \FloatTok{0.8}\NormalTok{, }\AttributeTok{list =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{train\_data }\OtherTok{\textless{}{-}}\NormalTok{ iris[train\_index\_iris, ]}
\NormalTok{test\_data }\OtherTok{\textless{}{-}}\NormalTok{ iris[}\SpecialCharTok{{-}}\NormalTok{train\_index\_iris, ]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-71-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(model}\SpecialCharTok{$}\NormalTok{finalModel)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confusionMatrix}\NormalTok{(test\_data}\SpecialCharTok{$}\NormalTok{species, predictions)}
\end{Highlighting}
\end{Shaded}
...
\end{minipage} & 25 distinct values & \includegraphics{/tmp/ds0144.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 7 (21.9\%)\\
8 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0145.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 27 distinct values & \includegraphics{/tmp/ds0146.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0147.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0148.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 1 (0.3)\strut
\end{minipage} & 29 distinct values & \includegraphics{/tmp/ds0149.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 2 (0.1)\strut
\end{minipage} & 30 distinct values & \includegraphics{/tmp/ds0150.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 18 (56.2\%)\\
1 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0151.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 19 (59.4\%)\\
1 : 13 (40.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0152.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
4 : 12 (37.5\%)\\
5 : 5 (15.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0153.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 1 ( 3.1\%)\\
8 : 1 ( 3.1\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0154.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
\end{longtable}
...
\caption{\label{fig:unnamed-chunk-86}Correlation Plot}
\end{figure}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-88-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-89-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-90-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-91-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-98-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-100-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-102-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-103-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-104-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-104-2.pdf}
...
\begin{figure}
\centering
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-106-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-108-1.pdf}
...
\includegraphics{Useful-Syntax_files/figure-latex/unnamed-chunk-109-1.pdf}
