...
\end{minipage} & 25 distinct values & \includegraphics{/tmp/ds0100.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 7 (21.9\%)\\
8 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0101.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 27 distinct values & \includegraphics{/tmp/ds0102.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0103.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
\end{minipage} & 22 distinct values & \includegraphics{/tmp/ds0104.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 1 (0.3)\strut
\end{minipage} & 29 distinct values & \includegraphics{/tmp/ds0105.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
IQR (CV) : 2 (0.1)\strut
\end{minipage} & 30 distinct values & \includegraphics{/tmp/ds0106.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 18 (56.2\%)\\
1 : 14 (43.8\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0107.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
0 : 19 (59.4\%)\\
1 : 13 (40.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0108.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
4 : 12 (37.5\%)\\
5 : 5 (15.6\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0109.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
...
6 : 1 ( 3.1\%)\\
8 : 1 ( 3.1\%)\strut
\end{minipage} & \includegraphics{/tmp/ds0110.png} & \begin{minipage}[t]{\linewidth}\raggedright
0\\
(0.0\%)\strut
\end{minipage} \\
\end{longtable}
