...
+====+===========+============================+====================+======================+=========+
| 1  | mpg\      | Mean (sd) : 20.1 (6)\      | 25 distinct values | ![](/tmp/ds0328.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 10.4 < 19.2 < 33.9\        |                    |                      |         |
|    |           | IQR (CV) : 7.4 (0.3)       |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 2  | cyl\      | Mean (sd) : 6.2 (1.8)\     | 4 : 11 (34.4%)\    | ![](/tmp/ds0329.png) | 0\      |
|    | [numeric] | min < med < max:\          | 6 :  7 (21.9%)\    |                      | (0.0%)  |
|    |           | 4 < 6 < 8\                 | 8 : 14 (43.8%)     |                      |         |
|    |           | IQR (CV) : 4 (0.3)         |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 3  | disp\     | Mean (sd) : 230.7 (123.9)\ | 27 distinct values | ![](/tmp/ds0330.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 71.1 < 196.3 < 472\        |                    |                      |         |
|    |           | IQR (CV) : 205.2 (0.5)     |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 4  | hp\       | Mean (sd) : 146.7 (68.6)\  | 22 distinct values | ![](/tmp/ds0331.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 52 < 123 < 335\            |                    |                      |         |
|    |           | IQR (CV) : 83.5 (0.5)      |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 5  | drat\     | Mean (sd) : 3.6 (0.5)\     | 22 distinct values | ![](/tmp/ds0332.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 2.8 < 3.7 < 4.9\           |                    |                      |         |
|    |           | IQR (CV) : 0.8 (0.1)       |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 6  | wt\       | Mean (sd) : 3.2 (1)\       | 29 distinct values | ![](/tmp/ds0333.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 1.5 < 3.3 < 5.4\           |                    |                      |         |
|    |           | IQR (CV) : 1 (0.3)         |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 7  | qsec\     | Mean (sd) : 17.8 (1.8)\    | 30 distinct values | ![](/tmp/ds0334.png) | 0\      |
|    | [numeric] | min < med < max:\          |                    |                      | (0.0%)  |
|    |           | 14.5 < 17.7 < 22.9\        |                    |                      |         |
|    |           | IQR (CV) : 2 (0.1)         |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 8  | vs\       | Min  : 0\                  | 0 : 18 (56.2%)\    | ![](/tmp/ds0335.png) | 0\      |
|    | [numeric] | Mean : 0.4\                | 1 : 14 (43.8%)     |                      | (0.0%)  |
|    |           | Max  : 1                   |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 9  | am\       | Min  : 0\                  | 0 : 19 (59.4%)\    | ![](/tmp/ds0336.png) | 0\      |
|    | [numeric] | Mean : 0.4\                | 1 : 13 (40.6%)     |                      | (0.0%)  |
|    |           | Max  : 1                   |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 10 | gear\     | Mean (sd) : 3.7 (0.7)\     | 3 : 15 (46.9%)\    | ![](/tmp/ds0337.png) | 0\      |
|    | [numeric] | min < med < max:\          | 4 : 12 (37.5%)\    |                      | (0.0%)  |
|    |           | 3 < 4 < 5\                 | 5 :  5 (15.6%)     |                      |         |
|    |           | IQR (CV) : 1 (0.2)         |                    |                      |         |
+----+-----------+----------------------------+--------------------+----------------------+---------+
| 11 | carb\     | Mean (sd) : 2.8 (1.6)\     | 1 :  7 (21.9%)\    | ![](/tmp/ds0338.png) | 0\      |
...
\caption{Correlation Plot}(\#fig:unnamed-chunk-7)
\end{figure}
