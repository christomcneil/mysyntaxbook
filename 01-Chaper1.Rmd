...
### Save dataframe as CSV  or R data file (with unique date)
...
*write these data to save file names*
...
### write these data to save files

```{r}
filenameallsav <- paste("data_amos/semdata_all",datenow,".sav",sep="")
filenamemalesav <- paste("data_amos/semdata_male",datenow,".sav",sep="")
filenamefemalesav <- paste("data_amos/semdata_female",datenow,".sav",sep="")
filenameallsav
```
...
### change data types (merging fails if data types are different)
...
### calculate dates and photoperiod (using geosphere library)
```{r}
